...
if (select==1):
    print("You have choosen Polo Shirts!")
    print("\n")
    ...
    print("You have choosen T-Shirts!")
    print("\n")
    col1= str(input("Please enter your desired colour:- "))
    qty1= int(input("Please enter your required quanitity:- "))
    rate=9.99
    ...
    confirm=int(input("Enter 1 to confirm / Enter 0 to go back to main menu :- "))
